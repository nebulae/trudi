...
class TestPredicate:
    def test_forensic_and_read_calls_count(self):
        ...
        assert ec.is_evidence_tool_call(_t("read.output --output /c/exports/x.csv"))
        assert ec.is_evidence_tool_call(_t("read.mail -o /c/exports/mail"))
    ...
    def test_meta_baselines_do_not_count(self):
        for cmd in ("<py>:misc_record_finding", "<py>:misc_record_agent_message",
                    ...
                    "<py>:accuracy_compare", "<py>:coverage_report"):
